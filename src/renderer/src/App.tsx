        ...
        <div className="app-container">
                ...
                <div>
                    ...
                    <nav>
                        <ul className="nav-list">
                            {NAV.map((n) => (
                                <li key={n.id} className={`nav-item ${activeTab === n.id ? 'active' : ''}`}
            ...
            <main className="main-viewport">
                ...
                <div className="content-scrollable">
                    {loading ? (
                        <div style={{padding: 40, textAlign: 'center', color: 'var(--text-muted)'}}>Loading Docker
                            environment…</div>
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                {' '}You can adjust the Docker host in <a className="domain-link"
                                                                          style={{cursor: 'pointer'}}
                                                                          onClick={() => setActiveTab('settings')}>Settings</a>.
                            </p>
                            <p style={{color: 'var(--text-muted)', marginTop: 12, fontSize: '0.85rem'}}>
                                Don't have Docker?{' '}
                                <a className="domain-link" href="https://www.docker.com/products/docker-desktop/"
