  ...
  return (
    <div style={{ padding: 24, backgroundColor: 'var(--bg-glass)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-lg)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        ...
        {field('Sites Root', s.sitesRoot, (v) => setS({ ...s, sitesRoot: v }))}
          <div>
              ...
              <select style={inp} value={theme} onChange={(e) => { const v = e.target.value as ThemePref; setTheme(v); setThemePref(v); }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.9rem' }}>
          <input type="checkbox" checked={s.stopOnQuit} onChange={(e) => setS({ ...s, stopOnQuit: e.target.checked })} />
